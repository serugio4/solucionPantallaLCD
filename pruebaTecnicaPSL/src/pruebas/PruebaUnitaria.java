...
public class PruebaUnitaria {
	...
	@Test
	public void testProcCadenaImprimirNumerosTamañoDos() {
		
		String[] arrayEntrada = {"2","567"};
		...
		assertArrayEquals(arrayEsperado, proc.imprimirCadenaDeNumeros(arrayEntrada));
	
	}
	
	@Test
	public void testProcCadenaImprimirNumerosTamañoOcho() {
		
		String[] arrayEntrada = {"8","10"};
		String[][] arrayEsperado =
			{{" ", " "," "," "," "," "," "," "," "," "," "," ","-","-", "-", "-", "-", "-", "-", "-", " ",},
			 {" ", " "," "," "," "," "," "," ","|"," "," ","|"," "," ", " ", " ", " ", " ", " ", " ", "|",},
			 {" ", " "," "," "," "," "," "," ","|"," "," ","|"," "," ", " ", " ", " ", " ", " ", " ", "|",},
